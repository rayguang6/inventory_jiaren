...
<div class="p-4 ">
    <div class="d-flex my-2">
        ...
        <!-- <button class="btn btn-primary ms-auto" id="export-warning-button">Export to CSV</button> -->
    </div>
...
<div class="p-4 ">
    <div class="d-flex my-2">
        ...
        <!-- <button class="btn btn-primary ms-auto" id="export-good-button">Export to CSV</button> -->
    </div>
